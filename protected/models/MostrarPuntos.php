 ...
 * @property string $pos
 */
class MostrarPuntos extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('lat, long, pos', 'required'),
			array('lat, long', 'length', 'max'=>50),
			array('pos', 'length', 'max'=>256),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, lat, long, pos', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return MostrarPuntos the static model class
	 */
